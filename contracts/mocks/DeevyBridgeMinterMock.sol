...
contract DeevyBridgeMinterMock is DeevyBridgeMinter {
    ...
    constructor(
        address l1ToL2AliasAddress,
        address deevyAddress,
        address l1TargetAddress
    ) public DeevyBridgeMinter(deevyAddress, l1TargetAddress) {
        l1ToL2Alias = l1ToL2AliasAddress;
    }

    function _getL1ToL2Alias() internal view override returns (address) {
        return l1ToL2Alias;
    }
}
