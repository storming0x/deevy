...
interface Deevy2Interface extends ethers.utils.Interface {
  functions: {
...
export class Deevy2 extends Contract {
  ...
  setName(tokenId: BigNumberish, overrides?: CallOverrides): Promise<string>;
